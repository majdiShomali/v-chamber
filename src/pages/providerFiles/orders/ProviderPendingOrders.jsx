...
const ProviderPendingOrders = () => {
  const ApiUrl = process.env.REACT_APP_API_URL;
    ...
    const {
     ...
     } = useSelector((state) => state.fetchAllOrders);
...
totalItemsUsers = AllOrdersData.length;
...
slicedArrayUsers = AllOrdersData.slice(startIndexUsers, endIndexUsers);
            ...
            role="rowgroup">
              <tr role="row">
                ...
                >
                  ...
                  <Icon  color="blue" path={mdiCarConnected} size={1.5} />

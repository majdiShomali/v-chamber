...
const EditJuiceNikotin = ({item,ItemData}) => {
    ...
    const handleSubmit = async (e) => {
      ...
      axios
        .put(`${ApiUrl}/updateJuiceNikotin/${item._id}`, data)
        .then(function () {
          dispatch(fetchRelatedItem(ItemData._id));
         dispatch(fetchJuiceNikotinByCategory(ItemData._id));
          handleClose();
        })
...
export default EditJuiceNikotin
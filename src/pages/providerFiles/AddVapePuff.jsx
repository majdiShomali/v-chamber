...
const AddVapePuff = ({item}) => {
    ...
    const {
      ...
      const handleSubmit = async (e) => {
        ...
        formData.append("selectedVapePuffColor", selectedColor);
        formData.append("selectedVapePuff", selectedVapePuff);
        formData.append("image", productImage);
        formData.append("itemVapePuff", JSON.stringify(item.vapePuff));
    
        axios
          .put(`http://localhost:5000/api/updateProductVapePuff/${item._id}`, formData)

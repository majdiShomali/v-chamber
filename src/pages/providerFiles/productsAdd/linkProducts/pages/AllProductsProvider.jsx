    ...
    if(selectedItem1  && !selectedItem2) {
      ...
      try {
        ...
        const linkedProductsItem2 = item2?.linkedProducts
          ...
          : [selectedItem1._id];
        const response = await axios.put(`${ApiUrl}/LinkProduct/${selectedItem1._id}/${item2._id}`, {
            linkedProductsItem1: linkedProductsItem1, linkedProductsItem2:linkedProductsItem2
        });
  ...
  <div className=" pb-5">
    ...
    <div className="flex items-center justify-between mx-">
      ...
      {item?.price > item?.salePrice ? 
                          ...
                          <span className="text-xl  font-semibold line-through text-gray-500 mr-3">${item?.price} </span>
                          <span className="text-xl text-black font-bold">${item?.salePrice}  </span>
                          </div>                      
                          :

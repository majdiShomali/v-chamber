...
const AddColor = ({item}) => {
    ...
    const handleSubmit = async (e) => {
      ...
      formData.append('itemColors',JSON.stringify(item.colors))
 
      axios
        .put(`http://localhost:5000/api/updateProductColor/${item._id}`,
        formData
        )
  ...
  return (
    <div className="w-full">
                   ...
                   <Icon
                   onClick={handleOpen}
                 className="cursor-pointer" path={mdiPlus} size={1} />

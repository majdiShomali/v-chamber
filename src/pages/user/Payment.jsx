...
const PaymentForm = () => {
  ...
  const handlePay = async (event) => {
    ...
    // const formattedCurrentDate = currentDate0.toISOString(); 
//     setTimeout(() => {
//       const oldDate = new Date(currentDate0);
//     const currentDate = new Date();
    
//     const timeDifference = currentDate - oldDate; // Difference in milliseconds

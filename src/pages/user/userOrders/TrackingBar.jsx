    ...
    <ol className="flex w-96 ">
      ...
      className="flex items-center w-full">
        ...
        >
          ...
          <svg
            className={orderStatus === "done" ? "w-4 h-4 text-blue-500 lg:w-5 lg:h-5 dark:text-blue-100" : "w-4 h-4 text-gray-500 lg:w-5 lg:h-5 dark:text-gray-100"}
            aria-hidden="true"
            xmlns="http://www.w3.org/2000/svg"
            fill="currentColor"
            viewBox="0 0 18 20"

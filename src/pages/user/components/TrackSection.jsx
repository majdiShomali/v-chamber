...
useEffect(()=>{
  ...
  <div className="grid max-w-screen-xl px-4 py-8 mx-auto lg:gap-8 xl:gap-0 lg:py-16 lg:grid-cols-12">
    <div className="mr-auto place-self-center lg:col-span-7">
      <h1 className="max-w-2xl mb-4 text-4xl font-extrabold tracking-tight leading-none md:text-5xl xl:text-6xl dark:text-white">
        Tracking tool for V-Chamber company 
      </h1>
  ...
  <div className="relative">
    ...
    <div className="hidden lg:mt-0 lg:col-span-5 lg:flex">
      <img
        src="https://static.vecteezy.com/system/resources/previews/004/896/077/original/pin-location-with-box-for-shipment-tracker-tracking-track-order-concept-illustration-flat-design-icon-sign-symbol-button-logo-stock-eps10-vector.jpg"
        alt="mockup"
      />
    </div>
  </div>
